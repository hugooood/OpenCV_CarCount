...
void drawCarCountOnImage(int &carCount01, cv::Mat &imgFrame2Copy);
...
int main(void) {
    ...
    //原始视频 D:\\NewCV\\resource\\NewCar00.mp4
...
//   while (capVideo.isOpened() && chCheckForEscKey != 27) {
    ...
    while (capVideo.isOpened() && chCheckForEscKey != 27) {
     ...
     //   cv::imshow("imgThreshCopy", imgThreshCopy);
        ...
        //判断车辆是否过线（Down）
        bool blnAtLeastOneBlockCrossedTheLine = checkIfBlocksCrossedTheLine01(blocks, intHorizontalLinePosition01, carCount01);
        ...
        if (blnAtLeastOneBlockCrossedTheLine == true) {
            ...
            cv::line(imgFrame2Copy, crossingLine01[0], crossingLine01[1], SCALAR_RED, 1);
        }
        //显示数字
        drawCarCountOnImage(carCount01, imgFrame2Copy);
